...
namespace SERVERSOAP\abstracts\message;

/**
 * abstract class for SoapMessage
 *
...
abstract class SoapMessage {
	 ...
	 *        	SOAP version constant SOAP_1_1|SOAP_1_2
	 *        	
	 * @return string
	 ...
	 * Set SOAP action.
	 *
	 * @param array(\BeSimple\SoapCommon\Mime\Part) $attachments
	 *        	Attachment array
	 */
